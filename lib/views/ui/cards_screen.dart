import 'package:flutter_grocery_app/controller/ui/cards_controller.dart';
  ...
  Widget topSellingProduct() {
    ...
    return MyCard(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const MyText.titleMedium("Top Selling Products", fontWeight: 600),
          MySpacing.height(20),
                ...
                children: [
                  Expanded(
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          const MyText.bodyMedium("Highest Bid",
                              fontWeight: 600, overflow: TextOverflow.ellipsis),
                  ...
                  SizedBox(
                    ...
                    child: Column(
                      ...
                      children: [
                        const MyText.bodyMedium("Ending-in",
                            fontWeight: 600, overflow: TextOverflow.ellipsis),
              ...
              children: [
                if (session >= 5000)
                  Icon(LucideIcons.trending_up,
                      size: 20, color: contentTheme.success),
                if (session < 5000)
                  Icon(LucideIcons.trending_down,
                      size: 20, color: contentTheme.danger),
                MySpacing.width(8),
                Expanded(
        ...
        child: Column(
          ...
          children: [
            Padding(
              ...
              child:
                  const MyText.titleMedium("Traffic Sources", fontWeight: 600),
            ),
  ...
  Widget card2() {
    return MyCard(
      ...
      child: Column(
        ...
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const MyText.bodyMedium("Card Title", fontWeight: 600),
          MyContainer(
            paddingAll: 0,
            ...
            children: [
              Padding(
                ...
                child: Row(
                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                  children: [
                    const MyText.titleMedium("Cards",
