import 'package:flutter_grocery_app/controller/ui/notification_controller.dart';
...
class _NotificationScreenState extends State<NotificationScreen>
  ...
  Widget buildTimeOut() {
    return Column(
      ...
      children: [
        const MyText.bodyMedium("Timeout", fontWeight: 600),
        SwitchListTile(
            ...
            dense: true,
            title:
                const MyText.bodyMedium("${"Infinite"} (∞)", fontWeight: 600)),
      ],
    );
  }
  ...
  Widget buildAction() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        const MyText.bodyMedium("Actions", fontWeight: 600),
        MySpacing.height(8),
        Theme(
          ...
          child: CheckboxListTile(
              ...
              dense: true,
              title:
                  const MyText.bodyMedium("Show Close Icon", fontWeight: 600)),
        ),
        Theme(
          data: ThemeData(unselectedWidgetColor: contentTheme.light),
          child: CheckboxListTile(
  ...
  Widget buildFloatingType() {
    return SizedBox(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const MyText.bodyMedium("Floating Type", fontWeight: 600),
          MySpacing.height(12),
  ...
  Widget buildColorVariation() {
    return SizedBox(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const MyText.bodyMedium("Color variation", fontWeight: 600),
          MySpacing.height(12),
  ...
  Widget buildMessageType() {
    return SizedBox(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          const MyText.bodyMedium("Message Type", fontWeight: 600),
          MySpacing.height(12),
            ...
            items: [
              DropdownMenuItem<bool>(
                ...
                child: InkWell(
                  ...
                  child: const MyText.labelMedium("Toast"),
                ),
              ),
              DropdownMenuItem<bool>(
                value: true,
                child: InkWell(
                    ...
                    child: const MyText.labelMedium("Banner")),
              ),
            ],
          ),
        ],
                            ...
                            Padding(
                              ...
                              child: Column(
                                ...
                                children: [
                                  ...
                                  MySpacing.height(12),
                                  const MyText.bodyMedium("Title Text",
                                      fontWeight: 600),
                                  MySpacing.height(8),
                                  TextFormField(
