...
import 'package:flutter_grocery_app/controller/ui/buttons_controller.dart';
            ...
            children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    const MyText.titleMedium("buttons",
                        ...
                        child: MyContainer.bordered(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding: MySpacing.only(left: 23, top: 20),
                                child: const MyText.titleMedium('Flat Button',
                                    fontWeight: 600),
                              ),
                              const Divider(height: 32),
                              Padding(
                        ...
                        child: MyContainer.bordered(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding: MySpacing.only(left: 23, top: 20),
                                child: const MyText.titleMedium('Soft Button',
                                    fontWeight: 600),
                              ),
                              const Divider(height: 32),
                              Padding(
                        ...
                        child: MyContainer.bordered(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding: MySpacing.only(left: 23, top: 20),
                                child: const MyText.titleMedium('Text Button',
                                    fontWeight: 600),
                              ),
                              const Divider(height: 32),
                              Padding(
                        ...
                        child: MyContainer.bordered(
                          ...
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding: MySpacing.only(left: 23, top: 20),
                                child: const MyText.titleMedium('Sized Button',
                                    fontWeight: 600),
                              ),
                              const Divider(height: 32),
                              Padding(
                      ...
                      child: MyContainer.bordered(
                        ...
                        child: Column(
                          ...
                          children: [
                            Padding(
                              padding: MySpacing.only(left: 23, top: 20),
                              child: const MyText.titleMedium('Button Group',
                                  fontWeight: 600),
                            ),
